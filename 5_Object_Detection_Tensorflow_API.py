...
PATH_TO_CKPT = os.path.join(CWD_PATH, 'E:\\tf_object_detection_code', MODEL_NAME, 'frozen_inference_graph.pb')
...
PATH_TO_LABELS = os.path.join(CWD_PATH, 'E:\\tf_object_detection_code\\object_detection\\data\\mscoco_label_map.pbtxt')
...
PATH_TO_TEST_IMAGES_DIR = 'E:\\tf_object_detection_code\\object_detection\\test_images\\'
